...
- Name: doctor-recording-upload.spec.ts >> Doctor upload recording (WebSocket) >> upload audio over WebSocket and render a pending note
- Location: tests/doctor-recording-upload.spec.ts:21:3
