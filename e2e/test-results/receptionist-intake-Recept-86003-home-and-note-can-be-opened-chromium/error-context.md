...
- Name: receptionist-intake.spec.ts >> Receptionist intake → doctor queue >> receptionist intake appears on doctor home and note can be opened
- Location: tests/receptionist-intake.spec.ts:16:3
